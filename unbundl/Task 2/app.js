...
function calculateTotal() {
    ...
    const chocolateTotal6 = getInputValue('chocolate5') * 40.00;
    const chocolateTotal7 = getInputValue('chocolate5') * 30.00;
    const chocolateTotal8 = getInputValue('chocolate5') * 80.00; 
...
document.getElementById('chocolate6-plus').addEventListener('click', function () {
    updateChocolateNumber('chocolate6', 40.00, true); 
});

document.getElementById('chocolate6-minus').addEventListener('click', function () {
    updateChocolateNumber('chocolate6', 40.00, false);
});

document.getElementById('chocolate7-plus').addEventListener('click', function () {
    updateChocolateNumber('chocolate7', 30.00, true); 
});

document.getElementById('chocolate7-minus').addEventListener('click', function () {
    updateChocolateNumber('chocolate7', 30.00, false);
});

document.getElementById('chocolate8-plus').addEventListener('click', function () {
    updateChocolateNumber('chocolate8', 80.00, true); 
});

document.getElementById('chocolate8-minus').addEventListener('click', function () {
    updateChocolateNumber('chocolate8', 80.00, false);
});
